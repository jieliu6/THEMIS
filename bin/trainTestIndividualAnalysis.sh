...
java generatingGausianMeansAL5Copies 12 20 0.05 1 0.18
javac updateOffDiagonalElementsForEMUntieVariancesIndividualAnalysis.java

DATA="updateOffDiagonalElementsForEMUntieVariancesIndividualAnalysis 0"
NUMFLOATS="31"
...
# get covariances from the file
 ...
 /net/noble/vol1/home/liu6/extendSpace/proj/2015itomic/tools/gmtk1.4.0/bin/gmtkViterbi \
	...
	-of1 $TEST -fmt1 ascii -nf1 $NUMFLOATS -ni1 2  \
	-island T -lst 14000 \
...
############################ take first step
    ...
    $EMTRAIN \
    	...
    	-of1 $TRAIN -fmt1 ascii -nf1 $NUMFLOATS -ni1 2 -dirichletPriors T \
